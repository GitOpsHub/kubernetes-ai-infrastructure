#!/usr/bin/env bash
# Install kube-prometheus-stack on EKS, pinned to ${KUBE_PROMETHEUS_STACK_VERSION}.
# Prereq: the EBS CSI driver add-on (chapter 00/create-cluster.sh or `eksctl create addon
# --name aws-ebs-csi-driver`) - Prometheus/Alertmanager PVCs need it.
set -euo pipefail
